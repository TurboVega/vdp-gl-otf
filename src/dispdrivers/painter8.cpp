...
void Painter8::readScreen(Rect const & rect, RGB222 * destBuf) {
}
...
void Painter8::writeScreen(Rect const & rect, RGB888 * destBuf) {
}

void Painter8::writeScreen(Rect const & rect, RGB222 * destBuf) {
}
