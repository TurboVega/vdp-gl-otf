/*
  Painter2 - Paints (draws) using 2 colors
...
std::function<void(int X, int Y, uint8_t colorIndex)> Painter2::setPixelLambda(PaintMode mode) {
  switch (mode) {
    case PaintMode::Set:
...
std::function<void(uint8_t * row, int x, uint8_t colorIndex)> Painter2::setRowPixelLambda(PaintMode mode) {
  switch (mode) {
    case PaintMode::Set:
...
std::function<void(int Y, int X1, int X2, uint8_t colorIndex)> Painter2::fillRowLambda(PaintMode mode) {
  switch (mode) {
    case PaintMode::Set:
...
void Painter2::absDrawLine(int X1, int Y1, int X2, int Y2, RGB888 color) {
...
void Painter2::fillRow(int y, int x1, int x2, RGB888 color) {
...
// parameters not checked
void Painter2::rawFillRow(int y, int x1, int x2, uint8_t colorIndex) {
...
// parameters not checked
void Painter2::rawORRow(int y, int x1, int x2, uint8_t colorIndex) {
...
// parameters not checked
void Painter2::rawANDRow(int y, int x1, int x2, uint8_t colorIndex) {
...
// parameters not checked
void Painter2::rawXORRow(int y, int x1, int x2, uint8_t colorIndex) {
...
// parameters not checked
void Painter2::rawInvertRow(int y, int x1, int x2) {
  auto row = m_viewPort[y];
  for (int x = x1; x <= x2; ++x)
    VGA2_INVERTPIXELINROW(row, x);
}

void Painter2::rawCopyRow(int x1, int x2, int srcY, int dstY) {
...
void Painter2::swapRows(int yA, int yB, int x1, int x2) {
...
void Painter2::VScroll(int scroll, Rect & updateRect) {
...
void Painter2::drawGlyph(Glyph const & glyph, GlyphOptions glyphOptions, RGB888 penColor, RGB888 brushColor, Rect & updateRect) {
  auto mode = paintState().paintOptions.mode;
...
void Painter2::invertRect(Rect const & rect, Rect & updateRect) {
  genericInvertRect(rect, updateRect,
                    [&] (int Y, int X1, int X2) { rawInvertRow(Y, X1, X2); }
                   );
}

void Painter2::swapFGBG(Rect const & rect, Rect & updateRect) {
...
void Painter2::copyRect(Rect const & source, Rect & updateRect) {
...
void Painter2::rawDrawBitmap_Mask(int destX, int destY, Bitmap const * bitmap, void * saveBackground, int X1, int Y1, int XCount, int YCount) {
  auto paintMode = paintState().paintOptions.mode;
...
void Painter2::rawDrawBitmap_RGBA2222(int destX, int destY, Bitmap const * bitmap, void * saveBackground, int X1, int Y1, int XCount, int YCount) {
  auto paintMode = paintState().paintOptions.mode;
  auto setRowPixel = setRowPixelLambda(paintMode);
...
void Painter2::rawDrawBitmap_RGBA8888(int destX, int destY, Bitmap const * bitmap, void * saveBackground, int X1, int Y1, int XCount, int YCount) {
  auto paintMode = paintState().paintOptions.mode;
  auto setRowPixel = setRowPixelLambda(paintMode);
...
void Painter2::rawCopyToBitmap(int srcX, int srcY, int width, void * saveBuffer, int X1, int Y1, int XCount, int YCount) {
...
void Painter2::rawDrawBitmapWithMatrix_Mask(int destX, int destY, Rect & drawingRect, Bitmap const * bitmap, const float * invMatrix) {
  auto paintMode = paintState().paintOptions.mode;
  auto setRowPixel = setRowPixelLambda(paintMode);
  auto foregroundColorIndex = RGB888toPaletteIndex(paintState().paintOptions.swapFGBG ? paintState().penColor : bitmap->foregroundColor);
...
void Painter2::rawDrawBitmapWithMatrix_RGBA2222(int destX, int destY, Rect & drawingRect, Bitmap const * bitmap, const float * invMatrix) {
  auto paintMode = paintState().paintOptions.mode;
  auto setRowPixel = setRowPixelLambda(paintMode);
...
void Painter2::rawDrawBitmapWithMatrix_RGBA8888(int destX, int destY, Rect & drawingRect, Bitmap const * bitmap, const float * invMatrix) {
  auto paintMode = paintState().paintOptions.mode;
  auto setRowPixel = setRowPixelLambda(paintMode);
