...
public:
   ...
   *
   * @return Return true if there is a mouse movement (deltas) available to read.
   */
  bool deltaAvailable();
   ...
   */
  void setupAbsolutePositioner(int width, int height, bool createAbsolutePositionsQueue, VideoController * updateDisplayController = nullptr);
...
private:
  ...
  VideoController * m_updateDisplayController;
};
